...
class MentalNote < Formula
  ...
  sha256 "7ef517887f437c605090d9611b704d206af72106c389f70407ffa6141db478df"
  ...
  test do
    ...
    assert_match "1.5.0", shell_output("#{bin}/mental-note --version")
    assert_match "1.5.0", shell_output("#{bin}/mn --version")
